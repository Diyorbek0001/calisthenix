...
$workoutLogId = (int) ($_GET['id'] ?? $_POST['id'] ?? 0);
...
$workout = getWorkoutByLogId($pdo, $userId, $workoutLogId);
...
$exerciseId = (int) $workout['exercise_id'];
$sets = (int) $workout['set_number'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $errors = updateWorkout($pdo, $userId, $workoutLogId, $exerciseId, $sets, $reps, $workoutDate);

    if (empty($errors)) {
        header('Location: dashboard.php?workout_updated=1');
        exit;
    }
}
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="feature-card">
                <h1 class="h3 mb-4">Edit Workout</h1>
                ...
                <form action="edit_workout.php" method="POST" novalidate>
                    <input type="hidden" name="id" value="<?php echo (int) $workoutLogId; ?>">
